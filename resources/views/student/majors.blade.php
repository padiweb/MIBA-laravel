...
<div class="row">
  <div class="col-md-4">
    <div class="box box-primary">
      <div class="box-header with-border"><h3 class="box-title">Tambah Unit Pendidikan</h3></div>
      <div class="box-body">
  ...
  <div class="col-md-8">
    <div class="box box-primary">
      <div class="box-header with-border"><h3 class="box-title">Daftar Unit Pendidikan</h3></div>
      <div class="box-body">
            ...
            <tr>
              ...
              <td>
                ...
                <form method="POST" action="{{ route('student.majors.destroy', $m->majors_id) }}" style="display:inline"
                      onsubmit="return confirm('Hapus unit pendidikan ini?')">
                  @csrf @method('DELETE')
