              ...
              <tbody>
                ...
                <tr class="{{ $lunas ? 'success' : 'danger' }}">
                  ...
                  <td class="text-center">
                    <a href="#" data-toggle="modal" data-target="#riwayat{{ $b->bebas_id }}"
                       class="label {{ $lunas?'label-success':'label-danger' }}">{{ $lunas?'Lunas':'Belum Lunas' }}</a>
                  </td>
                  <td class="text-center">
                ...
                <div class="modal fade" id="riwayat{{ $b->bebas_id }}">
                  <div class="modal-dialog modal-lg"><div class="modal-content">
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal">&times;</button>
                      <h4 class="modal-title">Riwayat Pembayaran / Angsuran</h4>
                    </div>
                    <div class="modal-body" style="padding:0">
                      <iframe src="{{ route('payout.riwayatBebas', $b->bebas_id) }}" width="100%" height="350" style="border:none"></iframe>
                    </div>
                    <div class="modal-footer">
                      <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
                    </div>
